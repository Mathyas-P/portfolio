    ...
    <section id="experience" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          <div className="absolute left-6 md:left-8 top-0 bottom-0 w-[2px] bg-white/10 shadow-[0_0_15px_rgba(99,102,241,0.6)]">
            <motion.div 
          ...
          {experienceData.map((exp, idx) => (
            ...
            >
              ...
              <div className="absolute left-6 md:left-8 w-10 h-10 rounded-full bg-[#030712] border-2 border-brand-primary -translate-x-1/2 flex items-center justify-center z-10 shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                <Briefcase size={16} className="text-brand-primary" />
              </div>

              {/* Content Card */}
              <div className="w-full pl-20 md:pl-32">
                <div className="premium-glass-card p-8 group hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="mb-4">
                    <span className="inline-block px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-brand-muted mb-4">
                      {exp.duration}
                    </span>
                  ...
                  <div className="bg-gradient-to-r from-brand-primary/10 to-transparent p-4 rounded-xl border border-brand-primary/20 relative overflow-hidden">
